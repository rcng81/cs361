...
//		PartTimeEmployee pEmp2 = new PartTimeEmployee("Melissa", "Will", "123456666", 23.5);
		...
		emp3.whoAmI();
		// TODO To complete
		// emp3.whoAmI() // prints "PART TIME EMPLOYEE" because emp3 references a PartTimeEmployee object
		// emp3.getHourlyRate(); // returns syntax error because emp3 is an Employee reference
		...
		// because emp1 is not a PartTimeEmployee instance. Emp1 is an Employee so casting it results in an error
